                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr class="odd">
                                                            ...
                                                            //$uid 
                                                            $token = $rows['token'];
                                                            $sqldegisen = "SELECT * FROM url where token = '$token' limit 1";
                                                            $resurl = $db->query($sqldegisen);
                                                            if (mysqli_num_rows($resurl) > 0) {
                                                                while ($rowsurl = $resurl->fetch_array(MYSQLI_ASSOC)) {
                                                            ?>
                                                                    <td><a type="button" href="messagedetail.php?t=<?php echo $token ?>"  class="btn btn-primary btn-user btn-block update">Detay</a></td>
                                                                    <td>#</td>
                                                                ...
                                                                ?>
                                                                <td>Herhangi Bir Aktivite Bulunamadı</td>
                                                                <td>#</td>
