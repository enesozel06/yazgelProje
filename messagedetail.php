            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary"><?php echo $gettoken?> Tokena ait veriler</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php
                                        $sqlmes = "select u.name,u.surname,u.id,l.clicks,l.uid,l.degismesayi,l.token from dev_users as u INNER JOIN url as l on u.id=l.uid where  l.token = '$gettoken'";
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr class="odd">
                                                            ...
                                                            <td><?php echo $rows['clicks'] ?></td>
                                                            <td><?php echo $rows['degismesayi'] ?></td>
